...
//       <form onSubmit={handleUpdate}>
//         <h1>Edit Meeting</h1>
//         <label className="label" htmlFor="projectName">Training Topic</label>
//         <input
//           id="projectName"
//           type="text"
//           name="projectName"
...
//         />
//         <label className="label" htmlFor="trainerName"> Faculty Name</label>
//         <input
//           id="trainerName"
//           type="text"
//           name="trainerName"
...
//         />
//         <label className="label" htmlFor="plantCode">Plant ID</label>
//         <input
//           id="plantId"
//           type="number"
//           name="plantId"
